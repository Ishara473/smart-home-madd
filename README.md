...
- Android APK builds are generated by the GitHub Actions workflow in [.github/workflows/build-apk.yml](.github/workflows/build-apk.yml).
- Create a tag in the form `v*` to publish an APK as a GitHub Release asset, which provides the final shareable APK link.
